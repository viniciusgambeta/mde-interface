          ...
          <div className="bg-slate-700/30 rounded-lg p-8">
            <div className="text-slate-300 text-sm leading-relaxed">
              ...
              <div className="flex items-center space-x-3 mt-3">
                <button className="flex items-center space-x-2 px-6 py-3 bg-transparent border-2 border-white hover:bg-white hover:text-slate-800 text-white rounded-xl font-medium transition-all duration-200 transform hover:scale-105">
