            ...
            <div className="flex items-center space-x-3 pl-[5px]">
              ...
              <div>
                <div className="flex items-center space-x-1">
                  <span className="text-white font-semibold text-xl">{currentPrompt.instructor?.name || 'Instrutor'}</span>
                  {currentPrompt.instructor?.social_linkedin && (
                    <a 
                      href={currentPrompt.instructor.social_linkedin} 
                      target="_blank" 
      ...
      <div className="w-full lg:w-96 border-l border-slate-700/30 flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-6">
          <div className="space-y-6" key={currentPrompt.id}>
            <h3 className="text-white font-semibold mb-6">Conteúdo Relacionado</h3>
            
            <SuggestedPrompts currentPrompt={currentPrompt} onVideoSelect={onVideoSelect} />
          </div>
        </div>
      </div>
    </div>
