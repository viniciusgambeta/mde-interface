/*
  # Sistema de Comentários - Usando Assinaturas
  ...
  2. Segurança
    ...
    - Políticas para CRUD baseadas na assinatura do usuário
    - Verificação se user_id corresponde à assinatura
...
-- Users can create comments if they have an active subscription
CREATE POLICY "Authenticated users with subscription can create comments"
  ON comments
  FOR INSERT
  TO authenticated
  WITH CHECK (
